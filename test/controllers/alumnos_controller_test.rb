...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference("Alumno.count") do
      post alumnos_url, params: { alumno: { edad: @alumno.edad, grado: @alumno.grado, nombre: @alumno.nombre } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { edad: @alumno.edad, grado: @alumno.grado, nombre: @alumno.nombre } }
